      ...
      <div className="w-full px-5 md:px-6 max-w-[1280px] mx-auto py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-16">
          ...
          <div className="md:col-span-5 space-y-6">
            <h2 className="font-display font-bold text-white text-xl tracking-tighter">
              JBU ASSOCIATION
            </h2>
            <p className="text-[#8292b0]/70 text-base max-w-sm">
              Jesus Bridge Us. Bridging People to Jesus Across Nations through
              prayer, discipleship, and global mission.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 border border-white/20 flex items-center justify-center text-white hover:text-[#C5A059] hover:border-[#C5A059] transition-all"
              >
          ...
          <div className="md:col-span-3 space-y-6">
            <h3 className="text-white font-sans text-xs font-semibold uppercase tracking-[0.05em]">
              Navigation
            </h3>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#8292b0]/70 hover:text-white transition-colors text-base"
                  >
                    {link.label}
                  </Link>
                </li>
